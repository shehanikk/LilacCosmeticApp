...
class eyeprimer : AppCompatActivity(), ProductLoadListener, CartLoadListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eyeprimer)
        init()
        ...
        btnBackEyeprimer.setOnClickListener(){
    ...
    private fun init(){
        ...
        rv_eyePrimer.layoutManager = gridLayoutManager
        rv_eyePrimer.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_eyePrimer.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(eyePrimerLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
