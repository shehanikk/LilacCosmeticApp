...
class lipgloss : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    private fun init(){
        ...
        rv_lipgloss.layoutManager = gridLayoutManager
        rv_lipgloss.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_lipgloss.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(lipglossLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
