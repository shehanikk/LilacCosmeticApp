...
class eyeliner : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    private fun init(){
        ...
        rv_eyeLiner.layoutManager = gridLayoutManager
        rv_eyeLiner.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_eyeLiner.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(eyeLinerLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
