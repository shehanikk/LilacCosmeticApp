...
import kotlinx.android.synthetic.main.activity_concealer.*
...
class concealer : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHomeConcealer.setOnClickListener(){
            val intent = Intent(this,home::class.java)
            startActivity(intent)
        }

        btnCategoryConcealer.setOnClickListener(){
            val intent = Intent(this,catogeries::class.java)
            startActivity(intent)
        }

        btnSaleConcealer.setOnClickListener(){
            val intent = Intent(this,sales::class.java)
            startActivity(intent)
        }

        btnBackConcealer.setOnClickListener(){
            val intent = Intent(this,face::class.java)
            startActivity(intent)
        }

        btnCartConcealer.setOnClickListener(){
    ...
    private fun init(){
        ...
        rv_concealer.layoutManager = gridLayoutManager
        rv_concealer.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_concealer.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(concealerLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
