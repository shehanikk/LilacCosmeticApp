...
class MyCartAdapter(
    ...
    private fun plusCartItem(holder: MyCartViewHolder, cartModel:cart) {
    ...
    private fun minusCartItem(holder: MyCartViewHolder, cartModel: cart) {
    ...
    private fun updateFirebase(cartModel: cart) {
        FirebaseDatabase.getInstance()
            .getReference("Cart")
            .child("UNIQUE_USER_ID")
            .child(cartModel.key!!)
