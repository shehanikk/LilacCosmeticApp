...
class highlighter : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    private fun init(){
        ...
        rv_highlighter.layoutManager = gridLayoutManager
        rv_highlighter.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_highlighter.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(highlighterLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
