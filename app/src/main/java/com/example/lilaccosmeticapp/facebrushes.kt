...
class facebrushes : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_facebrushes)
        init()
        loadProductFromFirebase()
        countCartFromFirebase()

        btnHomeFacebrushes.setOnClickListener(){
            val intent = Intent(this,home::class.java)
            startActivity(intent)
        }

        btnCategoryFacebrushes.setOnClickListener(){
            val intent = Intent(this,catogeries::class.java)
            startActivity(intent)
        }

        btnSaleFacebrushes.setOnClickListener(){
            val intent = Intent(this,sales::class.java)
            startActivity(intent)
        }

        btnBackFacebrushes.setOnClickListener(){
            val intent = Intent(this,tool::class.java)
            startActivity(intent)
        }

        btnCartFacebrushes.setOnClickListener(){
    ...
    private fun init(){
        ...
        rv_faceBrushes.layoutManager = gridLayoutManager
        rv_faceBrushes.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_faceBrushes.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(faceBrushesLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
