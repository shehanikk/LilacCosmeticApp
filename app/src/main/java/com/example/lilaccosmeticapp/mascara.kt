...
class mascara : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHomeMascara.setOnClickListener(){
        ...
        btnBackMascara.setOnClickListener(){
    ...
    private fun init(){
        ...
        rv_mascara.layoutManager = gridLayoutManager
        rv_mascara.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_mascara.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(mascaraLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
