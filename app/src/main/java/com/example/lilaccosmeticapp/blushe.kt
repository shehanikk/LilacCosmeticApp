...
import kotlinx.android.synthetic.main.activity_blushe.*
...
class blushe : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_blushe)
        init()
        loadProductFromFirebase()
        countCartFromFirebase()

        btnHomeBlushe.setOnClickListener(){
            val intent = Intent(this,home::class.java)
            startActivity(intent)
        }

        btnCategoryBlushe.setOnClickListener(){
            val intent = Intent(this,catogeries::class.java)
            startActivity(intent)
        }

        btnSaleBlushe.setOnClickListener(){
            val intent = Intent(this,sales::class.java)
            startActivity(intent)
        }

        btnBackBlushe.setOnClickListener(){
            val intent = Intent(this,face::class.java)
            startActivity(intent)
        }

        btnCartBlushe.setOnClickListener(){
    ...
    private fun init(){
        ...
        rv_blushe.layoutManager = gridLayoutManager
        rv_blushe.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_blushe.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(blusheLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
