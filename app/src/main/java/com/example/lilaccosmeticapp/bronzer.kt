...
class bronzer : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnHomeBronzer.setOnClickListener(){
            val intent = Intent(this,home::class.java)
            startActivity(intent)
        }

        btnCategoryBronzer.setOnClickListener(){
            val intent = Intent(this,catogeries::class.java)
            startActivity(intent)
        }

        btnSaleBronzer.setOnClickListener(){
            val intent = Intent(this,sales::class.java)
            startActivity(intent)
        }

        btnBackBronzer.setOnClickListener(){
            val intent = Intent(this,face::class.java)
            startActivity(intent)
        }

        btnCartBronzer.setOnClickListener(){
