...
class eyebrushes : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_eyebrushes)
        init()
    ...
    private fun init(){
        ...
        rv_eyeBrushes.layoutManager = gridLayoutManager
        rv_eyeBrushes.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_eyeBrushes.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(eyeBrushesLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
