...
class foundation : AppCompatActivity(), ProductLoadListener, CartLoadListener {
    ...
    private fun init(){
        ...
        rv_foundation.layoutManager = gridLayoutManager
        rv_foundation.addItemDecoration(SpaceItemDecoration())
    ...
    override fun onDrinkLoadSuccess(drinkModelList: List<product>?) {
        ...
        rv_foundation.adapter = adapter
    }

    override fun onDrinkLoadFailed(message: String?) {
        Snackbar.make(foundationLayout,message!!, Snackbar.LENGTH_LONG).show()
    }
